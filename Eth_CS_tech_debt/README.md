...
[`leanspec-vs-consensus-specs.md`](leanspec-vs-consensus-specs.md), sets these
findings against leanSpec dimension by dimension and analyses the cost of closing
the gap — repairing consensus-specs in place vs. building it on leanSpec's
framework.
